...
parser.add_argument('-p', '--plothist', nargs='?', default=None, const='alphabetic', choices=['alphabetic', 'decreasing'], help='[ORDERING] = [alphabetic, decreasing] \nThe user can specify if the histogram bar must be ordered in values-decreasing order or alphabetic-keys order. If nothing is passed to -p/--plothist, the default choice is alphabetic ordering.', metavar=('ORDERING'))
